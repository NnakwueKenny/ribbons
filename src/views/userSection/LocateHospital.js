...
const LocateHospital = () => {
    ...
    const getSARCLoc = () => {
        ...
        setIsSearching(true);
        const targetData = hospitalData.filter(item => item.state === searchQuery);
        console.log(targetData);
        setLocationDetails(targetData.length > 0? targetData[0].hospital: [] );
        setIsSearched(true)
        setTimeout(() => {
        ...
        <div className='flex flex-col gap-4 w-full h-full items-center px-3'>
            ...
            <div className='flex flex-col gap-4 w-full h-full items-center px-1'>
                <div className='flex w-full text-gray-600 text'>
                    ...
                    <div style={{fontFamily: `'Lato', sans-serif`}} className='w-full text-xl font-semibold text-purple-900'>Locate Hospital</div>
                </div>
                <p style={{fontFamily: `'Lato', sans-serif`}} className='text-gray-500 text-md italic max-w-sm'>
                    Select your state/province to see Hospitals closest to you...
                </p>
                ...
                </form>
                {
                    ...
                    <div className='w-full h-full border-t mt-4 py-2 font-normal'>
                    {
                        ...
                        :
                        <div className='w-full'>
                            <h2 style={{fontFamily: `'Lato', sans-serif`}} className='text-gray-700 py-2 font-semibold'>Registered Hospitals found in <span className='capitalize'>{foundLocation}</span></h2>
