        ...
        <div className='flex flex-col gap-4 w-full h-full items-center px-3'>
            ...
            <div className='flex flex-col gap-4 w-full h-full items-center px-1'>
                <div className='w-full flex flex-col gap-2'>
                    ...
                    <button  className='shadow w-full flex justify-center items-center gap-2 py-2 text-gray-600 hover:text-purple-900 hover:shadow-md'>
                ...
                <div className='relative w-full h-full px-3 py-4'>
                    <div className='absolute top-3 left-0 h-full w-full bg-white shadow'>
                        <div className='relative w-full h-full'>
                            ...
                            <div className='absolute w-full bottom-8 flex justify-around'>
                                <button className='text-3xl bg-gray-300 text-purple-900 border h-16 w-16 rounded-full'>
                    ...
                    </div>
                    {
                        ...
                        <div className='w-full grid grid-cols-2 gap-5'>
                            ...
                            <div className='w-full h-44 border rounded-lg overflow-hidden'>
                                <img alt='er' className='w-full h-full' src='https://images.pexels.com/photos/6003311/pexels-photo-6003311.jpeg?auto=compress&cs=tinysrgb&w=600' />
                            </div>
                        </div>
                        :
